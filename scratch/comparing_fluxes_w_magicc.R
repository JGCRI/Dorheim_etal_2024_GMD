...
magicc_ocean <- rbind(data.frame(year = c(1960, 1980, 1990, 2000, 2010, 2020, 2030, 2050, 2100),
                               ...
                               scenario = "ssp585"), 
                    data.frame(year = c(1960, 1980, 1990, 2000, 2010, 2020, 2030, 2050, 2100),
                               value = c(0.68, 1.40, 1.56, 1.71, 2.02, 2.44, 2.70, 2.88, 1.92), 
                               variable = OCEAN_CFLUX(), 
                               scenario = "ssp245"), 
                    data.frame(year = c(1960, 1980, 1990, 2000, 2010, 2020, 2030, 2050, 2100),
                               value = c(0.68, 1.40, 1.56, 1.71, 2.02, 2.40, 2.09, 1.17, -0.06), 
                               variable = OCEAN_CFLUX(), 
                               scenario = "ssp119"))
...
ggplot() + 
  ...
  geom_point(data = magicc_ocean, aes(year, value, color = "MAGICC 7")) + 
  geom_line(data = magicc_ocean, aes(year, value)) + 
  facet_wrap("scenario") + 
  labs(title = "ocean c uptake")
